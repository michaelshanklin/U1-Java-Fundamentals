public class L6{
        public static void main(String[] args){
          ...
          //powerScore1 = Math.pow(value1, value2); //throws an error
            ...
            //Math.min(double a, double b) - returns the lower of the two values
            //Math.max(double a, double b) - returns the higher of the two values

            //Using Math.max/min to return the lowest and highest of the three numbers
            ...
            int min2 = Math.max(Math.min(num1, num2), num3);
